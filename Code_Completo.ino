/* Código do robô elaborado para projeto de conclusão de curso
 *  Desenvolvimento de um veículo autoguiado para aplicações industriais
 * Orientador: Vinícius Kuhn
 * Coorientador: Fábio Itturriet
 * 
 * Desenvolvido por Cleber Quadros
 */
...
//Configuração de variaveis  KP, TI e TD  
...
void Ajusta_PID(){
    ...
    float PID = (Kp * P) + ((Kp/Ti) * I) + ((Kp*Td) * D); 
    //........................................
